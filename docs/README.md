...
3. `03-c4-diagrams.md`
4. `04-repo-structure.md`
5. `05-database-schema.md`
6. `06-api-contract.md`
7. `07-cicd-pipeline.md`
8. `08-helm-chart-structure.md`
9. `09-argocd-app-structure.md`
10. `10-terraform-azure-skeleton.md`
11. `11-excel-template-design.md`
12. `12-test-strategy.md`
13. `13-runbook.md`
14. `14-mvp-backlog.md`
15. `15-data-providers-and-adapters.md`
